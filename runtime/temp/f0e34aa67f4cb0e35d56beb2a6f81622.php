<?php /*a:2:{s:75:"/Users/guoyuzhao/sites/tuzisir-tool/application/admin/view/index/index.html";i:1539273331;s:77:"/Users/guoyuzhao/sites/tuzisir-tool/application/admin/view/common/header.html";i:1539250433;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-filter="left-nav">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="#" class="location" data-url="<?php echo url('/admin/tool/index'); ?>">码农 Tool</a></dd>
                        <dd><a href="#" class="location" data-url="<?php echo url('/admin/tool/index'); ?>">My Tool</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
